      ...
      <main className="flex flex-1 w-full max-w-2xl flex-col items-center justify-center py-32 px-6 text-center">
        ...
        <div className="flex flex-col gap-4 w-full max-w-sm">
          <button
            ...
            disabled={isLoading}
            className="flex h-12 w-full items-center justify-center rounded-lg bg-indigo-600 px-6 text-white font-medium transition-colors hover:bg-indigo-700 disabled:opacity-50"
          >
          ...
          <button
            onClick={() => setIsLoading(true)}
            disabled={isLoading}
            className="flex h-12 w-full items-center justify-center rounded-lg border-2 border-indigo-600 text-indigo-600 dark:text-indigo-400 dark:border-indigo-400 font-medium transition-colors hover:bg-indigo-50 dark:hover:bg-indigo-900/20 disabled:opacity-50"
          >
